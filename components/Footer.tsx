...
const Footer = () => {
  return (
    <footer className="mx-auto max-w-3xl px-4 sm:px-6 md:max-w-5xl ">
      <hr className="w-full h-[2px] mx-auto mt-8 dark:bg-neutral-600 border-0"></hr>
      <div className="mx-auto  p-4 flex flex-col text-center text-neutral-900 md:flex-row md:justify-between">
        <div className="flex flex-row items-center justify-center space-x-1 text-neutral-500 dark:text-neutral-100">
          © 2023 CPSi.London<a href="/" className="hover:underline"></a>
        </div>
     ...
     {/*      <a href="https://github.com/hqasmei" rel="noreferrer" target="_blank">
          ...
          <a
            href="https://twitter.com/cpsi_London"
            rel="noreferrer"
            target="_blank"
          >
            <AiOutlineTwitter
